...
{
    public class DeleteBasketItemCommandHandler : CommandHandlerBase<DeleteBasketItemCommand, Guid>
    {
        ...
        protected override async Task<Result<Guid, IDomainError>> ExecuteAsync(DeleteBasketItemCommand request, CancellationToken cancellationToken)
        {
